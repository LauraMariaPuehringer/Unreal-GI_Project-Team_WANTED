...
{
	TSharedPtr<SGraphPanel> GraphPanel = OwnerGraphHandler->GetGraphPanel();
	DrawWidgetToRenderTarget(GraphPanel);
}
...
{
	if (OwnerGraphHandler->GetNumberOfPendingNodesToCache())
	{
